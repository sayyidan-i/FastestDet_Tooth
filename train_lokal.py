...
class FastestDet:
    def __init__(self):
        ...
        if opt.weight is not None:
            ...
            self.model.load_state_dict(torch.load(opt.weight, map_location=torch.device('cpu')))
        else:
    ...
    def train(self):
        ...
        for epoch in range(self.cfg.end_epoch + 1):
            ...
            if epoch % 10 == 0 and epoch > 0:
                ...
                torch.save(self.model.state_dict(), "checkpoint/weight_AP05_{:.2f}_{}_epoch.pth".format(mAP05, epoch))
