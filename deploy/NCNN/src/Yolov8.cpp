...
int main()
{
    ...
    // 加载模型
    ncnn::Net net;
    net.load_param("./weights/yolov8_160-sim-opt.param");
    net.load_model("./weights/yolov8_160-sim-opt.bin");  
...
for (size_t i = 0; i < nms_boxes.size(); i++)
{
    ...
    cv::imwrite("./img/karies result yolov8.jpg", img);
