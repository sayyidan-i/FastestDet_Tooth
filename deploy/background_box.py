import cv2
import numpy as np
#https://github.com/amrizal94/object-tracking/blob/main/background_box.py
...
img: CV2 image with text and background
    ...
    (text_width, text_height) = cv2.getTextSize(
        text, font, fontScale=font_scale, thickness=thickness)[0]
    ...
    img[minY:yy, minX:xx] = res

    cv2.putText(img, text, (x, (y+h)), font, fontScale=font_scale,
                color=(text_B, text_G, text_R), thickness=thickness)
    return img, (minX, minY, xx, yy)